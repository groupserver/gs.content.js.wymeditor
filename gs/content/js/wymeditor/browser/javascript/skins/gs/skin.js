WYMeditor.SKINS['gs'] = {
    ...
    init: function(wym) {
        function rejig(toolbar, buttonSelector, newClass) {
            var newGroup=null, buttons=null;
        ...
        rejig(toolbar,
              '.wym_tools_strong, .wym_tools_emphasis, .wym_tools_superscript, .wym_tools_subscript',
              'gs_buttons_style');
        rejig(toolbar,
              '.wym_tools_link, .wym_tools_unlink',
              'gs_buttons_link')
        rejig(toolbar, 
              '.wym_tools_ordered_list, .wym_tools_unordered_list, .wym_tools_indent, .wym_tools_outdent',
              'gs_buttons_list')
        rejig(toolbar,
